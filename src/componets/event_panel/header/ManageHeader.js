...
const ManageHeader = () => {
  ...
  const fetchCompanyDetails = async () => {
    try {
      const response = await authFetch('https://mahadevaaya.com/eventmanagement/eventmanagement_backend/api/company-detail-item/1/', {
        method: 'GET'
      });
      ...
      setFormData({
        ...
        phone: data.phone,
        logo: null,
        profile_link: data.profile_link.length > 0 ? data.profile_link : [""]
      });
